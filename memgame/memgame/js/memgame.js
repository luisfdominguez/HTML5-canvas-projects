(function () {
	...
	var pairs = [
                ...
                ["img/7.png", "img/7-7.png"],
                ["img/8.png", "img/8-8.png"],
                ["img/9.png", "img/9-9.png"],
                ["img/10.png", "img/10-10.png"]
		];
	/*
	...
	*/
	...
	//generate deck of cards 10 pairs
	function makedeck() {
    ...
    function updateProgress() {
			...
			progress = $("#progressbar").progressbar("option","value");
				if (progress < 100) {
					...
					timeoutprogress = setTimeout(updateProgress, 6000);
				}
	...
	function wonGame() {
		$("#msg").html('<span>Felicitaciones! Ud. gano el juego!</span>').fadeIn(1000);
	}	 

	function lostGame() {
		$("#msg").html('<span>Lo siento ha perdido!</span>').fadeIn(1000);
	}
